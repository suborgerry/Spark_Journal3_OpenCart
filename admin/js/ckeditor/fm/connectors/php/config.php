 ...
 */
 ...
 chdir('js/ckeditor/fm/connectors/php');
...
$Config['UserFilesAbsolutePath'] = DIR_FS_DOCUMENT_ROOT . $Config['UserFilesPath'];
...
$Config['ConfigAllowedTypes'] = array('Image', 'Flash', 'Media') ;//'File', 
