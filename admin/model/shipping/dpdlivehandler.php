<?php
class ModelShippingDpdLivehandler extends Model {
    ...
    public function shipment_creation($orders_id = array()) {
        ...
        foreach ($orders_id as $order_id) {
            ...
            $correct_phone = $this->model_shipping_dialcodehelper->separatePhoneNumberFromCountryCode($order_data['telephone'], $country_code);
    ...
    public function requestCourier($data = array()) {
        ...
        if ($warehouse_info) {
            ...
            $correct_phone = $this->model_shipping_dialcodehelper->separatePhoneNumberFromCountryCode($warehouse_info['phone'], $country_code);
            $phone = $correct_phone['dial_code'] . $correct_phone['phone_number'];
