...
/******/ 	return __webpack_require__(__webpack_require__.s = "./backend/design/backups.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _draggablePopup_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_draggablePopup_scss__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tree_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tree.scss */ "../modules/tree.scss");
...
/* harmony default export */ __webpack_exports__["default"] = (function (obj) {
  $('.close-sub-items', obj).each(function () {
    ...
    var $ul = $('> ul', $li);
    var $closeHolder = $('> .close-holder, > * > .close-holder, > * > * > .close-holder', $li);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ "./backend/design/style.scss");
...
/* harmony import */ var src_tree__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/tree */ "../modules/tree.js");
...
function init() {
  ...
  $('.btn-export').on('click', function () {
    ...
    $.get("design/export-popup", {
      ...
      if (response === 'no-additionals') {
        $.post("design/export?theme_name=".concat(entryData.theme_name), {}, function (result) {
          window.location = "design/export?theme_name=".concat(entryData.theme_name);
        });
      } else {
        var $html = $(response);
        $html.css({
        ...
        var $btnSave = $("<span class=\"btn btn-save\">".concat(entryData.tr.IMAGE_SAVE, "</span>"));
        var $btnCancel = $("<span class=\"btn btn-cancel\">".concat(entryData.tr.IMAGE_CANCEL, "</span>"));
        ...
        $btnSave.on('click', function () {
          ...
          $.post("design/export?theme_name=".concat(entryData.theme_name), requestData, function (result) {
            window.location = "design/export?theme_name=".concat(entryData.theme_name);
            popup.remove();
          });
        });
        ...
        interactjs__WEBPACK_IMPORTED_MODULE_4___default()(popup.get(0)).resizable({
          edges: {
            right: true,
            bottom: true
          }
  ...
  $('.btn-import').each(function () {
    $(this).dropzone({
      url: "design/import?theme_name=".concat(entryData.theme_name),
      timeout: 300000,
      success: function success() {
        $container.removeClass('hided-box');
        $('.hided-box-holder', $container).remove(); //location.reload();
      },
