...
<div>
    <div class="halo-section banner-block-1  padding-bottom-30  "
         data-section-id="1573726840862" data-section-type="banner block 1">
        <div class="container" >
...
<?if(!$aSets['HIDE_SECTIONS']){?>
    ...
    if(!isset($aSct['FURL'])){continue;}?>
				<a href="<?=FURL_x?>/<?=$aSct['FURL']?>/">
					<div class="BoxMSct_x CmColorBrh CmColorBgLh card-text-overlay  ">
						<div class=""></div>
                        <div class="image">
                            <img class="lazyload"
                                 src="/<?=CM_DIR?>/media/sections/<?=$aSct['NOD']?>.png"
                                 data-src="/<?=CM_DIR?>/media/sections/<?=$aSct['NOD']?>.png"
                                 alt="" data-image>
                        </div>
